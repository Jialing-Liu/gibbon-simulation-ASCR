...
sim1<-sim_density(n_sims=10, n_inst=50, n=3, distance=5000,
                  sigma=1000,  hardcore=list(beta=5e-5, hc = 700),
                  simulate = F, buffer=3000, start_d=0.005,by=0.0002)
...
sim2<-sim_density(n_sims=10, n_inst=50, n=3, distance=4500,
                  sigma=1000,  hardcore=list(beta=5e-5, hc = 700),
                  simulate = F, buffer=3000, start_d=0.005,by=0.0002)
#plot error ratios of density
...
sim3<-sim_density(n_sims=10, n_inst=50, n=3, distance=4000,
                  sigma=1000,  hardcore=list(beta=5e-5, hc = 700),
                  simulate = F, buffer=3000, start_d=0.005,by=0.0002)
#plot error ratios of density
...
#hardcore, distance=4000, traps in 3*3
sim4<-sim_density(n_sims=10, n_inst=50, n=3, distance=3500,
                  sigma=1000,  hardcore=list(beta=5e-5, hc = 700),
                  simulate = F, buffer=3000, start_d=0.005,by=0.0002)
#plot error ratios of density
...
#hardcore, distance=5000, traps in 3*3
sim5<-sim_density(n_sims=5, n_inst=25, n=3, distance=4000,
                  sigma=1000,  hardcore=list(beta=5e-5, hc = 700),
                  simulate = F, buffer=3000, start_d=0.005,by=0.0004)
#plot error ratios of density
plot(y=rowMeans(sim5), x=seq(0.005, 0.0146, 0.0004), xlab = 'Density/Hectare',
     ylab = 'Estimate / True Density', xlim = c(0.004,0.021),ylim=c(0.5,1.1),
     main = 'Effect of density on error for ASCR method(sigma=1000)',pch=16,cex=.8,col='blue')

sim6<-sim_density(n_sims=10, n_inst=25, n=3, distance=3500,
                  sigma=1000,  hardcore=list(beta=5e-5, hc = 200),
                  simulate = F, buffer=3000, start_d=0.005,by=0.0004)